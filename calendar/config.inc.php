...
$config['calendar_first_hour'] = 7;

// working hours begin
$config['calendar_work_start'] = 7;

// working hours end
$config['calendar_work_end'] = 19;
...
$config['calendar_itip_smtp_server'] = 'tls://smtp.raclus.net:587';
...
$config['calendar_caldav_url'] = 'https://webdav.raclus.net/%u/';

// Crypt key to encrypt passwords for added iCAL/CalDAV calendars
$config['calendar_crypt_key'] = "0f1d167a-0c04-437e-8804-a5e4ebc47faa";
...
// Caldav driver is supported only
 $config['calendar_preinstalled_calendars'] = array(
        'Personal' => array(
                ...
                'caldav_user'  => '%u',
                'caldav_pass'  => '%p',
                'caldav_url'   => 'https://webdav.raclus.net/%u/calendar/',
